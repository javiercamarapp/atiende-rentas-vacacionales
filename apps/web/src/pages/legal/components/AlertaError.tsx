...
/** Copia local deliberada de `pages/mensajeria/components/AlertaError.tsx`
 * (mismo comportamiento) — nunca se importa un archivo de la carpeta
 * exclusiva de otro lote (docs/fase2/LOTES.md). */
