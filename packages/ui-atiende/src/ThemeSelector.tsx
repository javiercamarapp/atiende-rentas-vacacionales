// Portado tal cual de atiende-restaurantes (src/components/ThemeSelector.tsx,
// D-015): claro/sistema/oscuro en localStorage, "sistema" solo se resuelve
// mientras el usuario lo tenga elegido explícitamente (nunca oscurece la app
// solo porque el SO esté en oscuro sin que el usuario lo haya pedido).
import { useEffect, useState } from "react";
import { Sun, Monitor, Moon } from "lucide-react";

const KEY = "atiende-rv-tema";
