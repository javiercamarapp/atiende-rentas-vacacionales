// Portado tal cual de atiende-restaurantes (src/components/AtiendeLogo.tsx,
// D-015) — misma reconstrucción vectorial del logo (figura corriendo +
// líneas de movimiento + wordmark "atiende"), sin cambios de marca para
// Rentas Vacacionales (identidad "atiende" compartida entre verticales).
